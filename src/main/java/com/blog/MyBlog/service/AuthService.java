...
import com.blog.MyBlog.security.JwtProvider;
...
public class AuthService {
    ...
    public void signup(RegisterRequest registerRequest) {
        ...
        mailService.sendMail(new NotificationEmail("Please activate your account ",
                user.getEmail(), "Thank you for signing up to Phoenix Blog, please click on the below url to activate your account : " +
    ...
    private void fetchUserAndEnable(VerificationToken verificationToken) {
        ...
        User user = userRepository.findByUsername(username).orElseThrow(() -> new SpringPostException("User not found with name: " + username));
